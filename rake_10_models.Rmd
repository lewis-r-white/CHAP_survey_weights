...
survey::svytotal(c(rep(1, nrow(full_survey))), survey_design)

#check out house rooms
svytotal(~rooms_two_plus, design = survey_design)
confint(svytotal(~rooms_two_plus, design = survey_design))

svytotal(~sleeping_rooms_two_plus, design = survey_design)
confint(svytotal(~sleeping_rooms_two_plus, design = survey_design))

svytotal(~separate_cooking, design = survey_design)
confint(svytotal(~separate_cooking, design = survey_design))

#check out lighting 
svytotal(~light_source_main, design = survey_design, na.rm = TRUE)
confint(svytotal(~light_source_main, design = survey_design, na.rm = TRUE))
```
...
#check out house rooms
svytotal(~rooms_three_plus, design = trimmed_raked_surv)
