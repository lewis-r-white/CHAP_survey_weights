...
# Create a replicate-weights survey design object from a traditional strata/cluster survey design object
...
raked_surv <- rake(survey_design, list(~urban_rural_str, ~LPG_main, ~CW_main), list(pop.urban_rural_str, pop.LPG_main, pop.CW_main))
...
trimmed_raked_surv <- trimWeights(raked_surv, lower=0.1, upper=5647,
                                   strict = TRUE)
...
raked_surv <- rake(survey_design, list(~urban_rural_str, ~LPG_main, ~CW_main, ~region), list(pop.urban_rural_str, pop.LPG_main, pop.CW_main, pop.region_hh))
...
#LPG main stove
svytotal(~collapsed_fuel, design = raked_surv)
...
# RAKE 5 AND RAKE 6 IN THE anesrake_version.Rmd doc. 
